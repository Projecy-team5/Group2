...
<head>
    @php
        ...
        $userRoleLabel = $authUser ? optional($authUser->role)->name ?? ($isAdminUser ? 'Admin' : 'User') : null;
        $unreadContactCount = $isAdminUser ? \App\Models\Contact::where('is_read', false)->count() : 0;
            ...
            <div class="pt-2">
                ...
                <div class="mt-2 space-y-1">
                    <a href="{{ route('admin.users.index') }}"
                        ...
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.users.*')) text-primary @endif"
                    ...
                    <a href="{{ route('admin.roles.index') }}"
                        ...
                        @else
                            text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif">
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.roles.*')) text-primary @endif"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.scholarships.index') }}"
                        ...
                        @else
                            text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif">
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.scholarships.*')) text-primary @endif"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.articles.index') }}"
                        ...
                        @else
                            text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif">
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.articles.*')) text-primary @endif"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                        </svg>
                    ...
                    <a href="{{ route('admin.categories.index') }}"
                        ...
                        @else
                            text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif">
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.categories.*')) text-primary @endif"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                        </svg>
                    ...
                    <a href="{{ route('admin.contacts.index') }}"
                        ...
                        @else
                            text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif">
                        <svg class="w-5 h-5 flex-shrink-0 @if (request()->routeIs('admin.contacts.*')) text-primary @endif"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex items-center gap-4">
            <div class="relative">
                <button type="button" id="languageToggle" aria-haspopup="true" aria-expanded="false"
                    ...
                    @endphp
                    <span class="sr-only">{{ $currentFlag['label'] ?? 'English' }}</span>
                    {!! $renderFlag($flagCode) !!}
                </button>
                    ...
                    <div id="profileMenuPanel"
                        ...
                        <div class="bg-primary text-white text-center px-6 py-6">
                            <div class="mx-auto w-20 h-20 rounded-full border-4 border-white bg-white/20 flex items-center justify-center mb-3">
                                ...
                                @else
                                    <span class="text-2xl font-semibold">{{ substr(Auth::user()->name, 0, 1) }}</span>
                                @endif
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('click', (event) => {
                ...
                if (profilePanel && !profilePanel.classList.contains('hidden') && !profilePanel.contains(
                        target) && !profileToggle?.contains(target)) {
                    closeProfileMenu();
                }

                if (notificationPanel && !notificationPanel.classList.contains('hidden') && !
                    notificationPanel.contains(target) && !notificationToggle?.contains(target)) {
                    closeNotificationMenu();
                }

                if (languagePanel && !languagePanel.classList.contains('hidden') && !languagePanel.contains(
                        target) && !languageToggle?.contains(target)) {
                    closeLanguageMenu();
                }
            });
