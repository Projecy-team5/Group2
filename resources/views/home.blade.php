...
<body class="bg-gray-50">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block ml-10">
                        <div class="flex space-x-8">
                            <a href="#" class="text-gray-900 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition-colors">Home</a>
                            <a href="#" class="text-gray-500 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition-colors">Scholarships</a>
                            <a href="#" class="text-gray-500 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition-colors">About</a>
                            <a href="#" class="text-gray-500 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition-colors">Resources</a>
                            <a href="#" class="text-gray-500 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition-colors">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-500 hover:text-indigo-600 px-4 py-2 text-sm font-medium border border-transparent hover:border-gray-300 rounded-lg transition-all">Login</a>
                    <a href="#" class="bg-indigo-600 text-white px-4 py-2 text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                <div class="text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="#" class="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-colors shadow-lg">
                            Find Scholarships
                        </a>
                        <a href="#" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-indigo-600 transition-colors">
                            How It Works
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-lg card-hover">
                    ...
                    <p class="text-gray-600 leading-relaxed">Our AI-powered algorithm matches you with scholarships based on your profile, interests, and academic achievements.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg card-hover">
                    ...
                    <p class="text-gray-600 leading-relaxed">Keep track of all your applications, deadlines, and requirements in one organized dashboard.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg card-hover">
                    ...
                    <p class="text-gray-600 leading-relaxed">Get personalized advice from education counselors and successful scholarship recipients.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <span class="bg-green-100 text-green-800 text-sm font-medium px-3 py-1 rounded-full">Merit-Based</span>
                ...
                <div class="border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <span class="bg-blue-100 text-blue-800 text-sm font-medium px-3 py-1 rounded-full">Need-Based</span>
                    ...
                    <p class="text-gray-600 mb-4">Supporting students who demonstrate community service and leadership.</p>
                    <div class="flex items-center justify-between text-sm text-gray-500">
                ...
                <div class="border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <span class="bg-purple-100 text-purple-800 text-sm font-medium px-3 py-1 rounded-full">Creative</span>
                    ...
                    <p class="text-gray-600 mb-4">For creative students pursuing arts, design, or creative technology.</p>
                    <div class="flex items-center justify-between text-sm text-gray-500">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                        <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1494790108755-2616b612e29f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Sarah">
                        <div class="ml-4">
                            <div class="font-semibold text-gray-900">Sarah Johnson</div>
                            <div class="text-gray-600 text-sm">Computer Science</div>
                        </div>
                    </div>
                    <p class="text-gray-600 italic">"ScholarshipHub helped me find and win $45,000 in scholarships. The platform made the entire process so much easier!"</p>
                </div>

                <div class="bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                        <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Michael">
                        <div class="ml-4">
                            <div class="font-semibold text-gray-900">Michael Chen</div>
                            <div class="text-gray-600 text-sm">Pre-Med</div>
                        </div>
                    </div>
                    <p class="text-gray-600 italic">"The smart matching feature connected me with scholarships I never would have found on my own. Incredible platform!"</p>
                </div>

                <div class="bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                        <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Emily">
                        <div class="ml-4">
                            <div class="font-semibold text-gray-900">Emily Rodriguez</div>
                            <div class="text-gray-600 text-sm">Business</div>
                        </div>
                    </div>
                    <p class="text-gray-600 italic">"Thanks to ScholarshipHub, I'm graduating debt-free. The application tracking feature kept me organized throughout."</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="gradient-bg py-20">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-xl text-indigo-100 mb-8">Join thousands of students who are already on their path to debt-free education.</p>
            <a href="#" class="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-colors shadow-lg">
