...
@section('content')
    <div class="w-full max-w-4xl bg-white rounded-lg shadow-xl p-6 sm:p-8 lg:p-10 h-auto">
        ...
        <form action="{{ route('admin.scholarships.update', $scholarship) }}" method="POST" class="space-y-6 w-auto h-auto">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea
                    ...
                    required
                >{{ old('application_description', $scholarship->application_description) }}</textarea>
            ...
            <div x-data='{
                requirements: @json(old('application_requirements', $scholarship->application_requirements ?? ['Transcripts', 'Personal Statement'])),
                newRequirement: ""
            }'>
            ...
            <div class="flex justify-center pt-4 space-x-4">
                ...
                <button
                    type="submit"
                    class="px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                    Update Scholarship
                </button>
            </div>
