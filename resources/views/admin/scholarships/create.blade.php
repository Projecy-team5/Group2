...
<div class="p-6">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Add a new scholarship to the system</p>
    </div>
        ...
        <form action="{{ route('admin.scholarships.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="application_requirements" id="application_requirements" rows="3"
                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" 
                          placeholder="e.g., Transcripts, Personal Statement, Letters of Recommendation">{{ old('application_requirements') }}</textarea>
