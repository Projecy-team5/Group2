            ...
            <div class="flex items-center gap-4 flex-1">
                <div class="flex items-center gap-3">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Add a new scholarship to the system</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form action="{{ route('admin.scholarships.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group">
                        <label for="application_requirements" class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-500">
                                <path d="M9 12l2 2 4-4" />
                        ...
                        <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                            <div id="requirements-container" class="space-y-3">
                                <div class="requirement-item flex gap-3 items-center">
                                    ...
                                    <button type="button" class="inline-flex items-center justify-center w-10 h-10 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors duration-200 remove-requirement hidden">
                            ...
                            <button type="button" id="add-requirement" class="mt-4 inline-flex items-center justify-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M5 12h14" />
                                    <path d="M12 5v14" />
                                </svg>
