            ...
            <form method="POST" action="{{ route('admin.business-settings.update') }}" enctype="multipart/form-data"
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
                    <div class="border-b border-gray-200 px-6 py-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">These fields power the About, Contact, and footer sections.
                        </p>
                    </div>
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Organization Name<span
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
                    <div class="border-b border-gray-200 px-6 py-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Used on the landing page navigation, emails, and browser tab.
                        </p>
                    </div>
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div id="logoPreviewWrapper" class="mt-4 hidden">
                                    <p class="text-xs font-semibold text-gray-500 uppercase mb-2">New Logo Preview</p>
                                ...
                                @if ($settings->logo_url)
                                    <div class="mt-4">
                                        <p class="text-xs font-semibold text-gray-500 uppercase mb-2">Current Logo</p>
                            ...
                            <div>
                                ...
                                <input type="file" id="faviconInput" name="favicon"
                                    ...
                                    class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary focus:border-primary bg-white" />
                                <p class="text-xs text-gray-500 mt-2">PNG, SVG, ICO up to 1MB. Ideally 64x64px square.</p>
                                @error('favicon')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                                <div id="faviconPreviewWrapper" class="mt-4 hidden">
                                    <p class="text-xs font-semibold text-gray-500 uppercase mb-2">New Favicon Preview</p>
                                    <div
                                ...
                                @if ($settings->favicon_url)
                                    <div class="mt-4">
                                        <p class="text-xs font-semibold text-gray-500 uppercase mb-2">Current Favicon</p>
                                        <div
