            ...
            <div class="col-span-12 rounded-2xl border border-gray-200 bg-white shadow-sm">
                <div class="flex items-center gap-3 border-b border-gray-100 px-6 py-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Give the post a clear headline, synopsis, and the full story.</p>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3"
                                ...
                                placeholder="Short description used for teasers">{{ old('excerpt') }}</textarea>
                        </div>
                        <div class="group">
                            ...
                            <textarea id="content" name="content" rows="12" required
                                ...
                                placeholder="Start writing your amazing article">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="rounded-xl border border-gray-200 bg-gray-50 p-5">
                            <div class="flex items-center justify-between border-b border-gray-100 pb-4">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Control when the article goes live.</p>
                                </div>
                            </div>
