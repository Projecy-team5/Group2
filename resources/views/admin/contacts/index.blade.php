    ...
    <div class="p-6 pt-0 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">{{ __('Manage and respond to customer inquiries') }}</p>
            </div>
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-lg">
                    ...
                    <div class="text-sm">
                        ...
                        <span class="text-blue-700">{{ __('Unread') }}</span>
                    </div>
                </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">{{ __('Subject') }}</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">{{ __('Message Preview') }}</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">{{ __('Date') }}</th>
                            <th class="px-6 py-4 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider">{{ __('Actions') }}</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-900">{{ __('No messages yet') }}</p>
                                            <p class="text-sm text-gray-500 mt-1">{{ __('Contact form submissions will appear here') }}</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm px-6 py-4">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="text-sm text-gray-600">
                        {{ __('Showing :from to :to of :total messages', ['from' => $messages->firstItem(), 'to' => $messages->lastItem(), 'total' => $messages->total()]) }}
                    </div>
