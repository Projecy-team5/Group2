                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            @if ($roles->isEmpty())
                                <div class="mb-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm text-amber-700">
                                    No roles available yet. <a href="{{ route('admin.roles.create') }}"
                                        class="font-semibold underline">Create one</a> to continue.
                                </div>
                            @endif
                            <div class="relative">
                                <select name="role_id" id="role_id" class="block w-full pl-3 pr-10 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 focus:bg-white" @disabled($roles->isEmpty()) required>
